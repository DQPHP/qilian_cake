...
class AppController extends Controller {
    ...
    public $meta_title;         // SEO, meta-title
    public $meta_description;   // SEO, meta-description
    public $meta_keywords;      // SEO, meta-keywords * Google&Yahoo 已取消该设置的评价
    public $css;                // css meta
    ...
    /* 面包屑页面导航 */
    public $breadcrumbs = array( '/news' => 'Home' );
    ...
    function beforeFilter() {
        ...
        // css
        $this->css = array('bootstrap.min', 'modern-business', 'style', 'footer');
        
        $this->meta_title = '七联就职';
        $this->meta_description = '七联就职社，日本最大的留学生、社会人交流就职转职平台。';
    }
    ...
    //    return $this->redirect('http://qilian.jp/appointment/notfound');
    // }
