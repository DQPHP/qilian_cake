...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <?php echo $this->Form->create('Post', array('url' => array( 'controller' => 'news', 'action' => 'add' ),  'name' => 'frm' ));?>
      ...
      <div class="form-group">
        <label>文章内容</label>
        <textarea name="data[Post][content]" id="mdeditor" cols="30" rows="20" class="form-control"><?php echo $demo_text;?></textarea>
      </div>
