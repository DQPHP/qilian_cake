...
<table class="table table-striped table-hover ">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <h5>
          <a href="/news/detail/<?php echo $post['Post']['id'];?>">
      ...
      <td>
        <ul class="list-inline">
          <li>
            <?php 
            echo $this->Html->link('<i class="fa fa-pencil"></i>修改', array('action' => 'modify', $post['Post']['id']), array( 'escape' => false, 'target' => '_blank', 'class' => "btn btn-blue"));
            ?>
          </li>
          <li>
            <?php
            echo $this->Html->link('<i class="fa fa-remove"></i>删除', array('action' => 'delete', $post['Post']['id']), array( 'escape' => false, 'class' => "btn btn-red" ), "确认删除【".$post['Post']['title']."】课程信息？");
            ?>
          </li>
        </ul>
