<div class="well">
  <?php echo $this->Form->create('Member', array('url' => array( 'controller' => 'member', 'action' => 'add' ), 'class' => 'form-horizontal', 'name' => 'frm' ));?>
    <fieldset>
      <legend>新成员加入！</legend>
      ...
      <div class="form-group">
          ...
          <div class="col-lg-10">
            ...
            <img id="eyecatch_url_4x3" src="" style="width: 120px; height: 160px;"/>
